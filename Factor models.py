...
paths = {
    "returns": folder / "49_Industry_Portfolios_Monthly.csv",
    "ff3": folder / "F-F_Research_Data_Factors.csv",
    "ff5": folder / "F-F_Research_Data_5_Factors_2x3.csv",
    "momentum": folder / "F-F_Momentum_Factor.csv"
}
